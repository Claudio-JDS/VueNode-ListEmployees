      ...
      <div class="card-body">
        <form v-on:submit.prevent="handleSubmitForm">
          ...
          <div class="form-group">
            ...
            <input type="text" id="name" class="form-control" placeholder="Type Your Name" v-model="employee.name"
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Type Job" v-model="employee.job_role"
          ...
          <div class="form-group">
            ...
            <input type="number" id="salary" class="form-control" placeholder="Salary" v-model="employee.salary"
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" placeholder="YYYY/MM/DD" v-model="employee.birth"
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Employee Registration"
              v-model="employee.employee_registration" :class="{'is-invalid': v$.employee_registration.$error}">
